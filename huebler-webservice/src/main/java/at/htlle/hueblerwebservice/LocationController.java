...
public class LocationController {
	...
	private ArrayList<Location> knownLocations = new ArrayList<Location>();
	...
	@GetMapping("/location")
    public Location location(@RequestParam(value = "city", defaultValue = "Leoben") String name) {
